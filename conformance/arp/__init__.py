...
imports NANDA chapter or member-sdk modules. Any ARP implementation can
...
SCHEMA_DIR = Path(__file__).resolve().parent.parent.parent / "schema" / "arp" / "0.1"
